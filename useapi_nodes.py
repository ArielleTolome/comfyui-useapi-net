...
class UseapiTokenFromEnv(_BaseNode):
...
class UseapiVeoUpscale(_BaseNode):
...
class UseapiVeoExtend(_BaseNode):
...
class UseapiGoogleFlowUploadAsset(_BaseNode):
...
class UseapiGoogleFlowImageUpscale(_BaseNode):
...
class UseapiRunwayUploadAsset(_BaseNode):
...
class UseapiRunwayVideoToVideo(_BaseNode):
...
class UseapiRunwayFramesGenerate(_BaseNode):
...
class UseapiRunwayImageUpscaler(_BaseNode):
...
class UseapiLoadVideoFrame(_BaseNode):
...
class UseapiVideoToFrames(_BaseNode):
...
class UseapiPreviewVideo(_BaseNode):
...
class UseapiVeoVideoToGif(_BaseNode):
...
class UseapiVeoConcatenate(_BaseNode):
...
class UseapiRunwayImages(_BaseNode):
...
class UseapiRunwayGen4Upscale(_BaseNode):
...
class UseapiRunwayActTwo(_BaseNode):
...
class UseapiRunwayActTwoVoice(_BaseNode):
...
class UseapiRunwayLipsync(_BaseNode):
...
class UseapiRunwaySuperSlowMotion(_BaseNode):
...
class UseapiRunwayTranscribe(_BaseNode):
...
class UseapiRunwayGen3TurboExtend(_BaseNode):
...
class UseapiRunwayAleph(_BaseNode):
...
class UseapiRunwayGen3TurboExpand(_BaseNode):
...
class UseapiRunwayGen3TurboActOne(_BaseNode):
...
NODE_CLASS_MAPPINGS = {
    ...
    "UseapiVideoToFrames":            UseapiVideoToFrames,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "UseapiVideoToFrames":            "Useapi Video to Frames",
